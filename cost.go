// Ryan Bell
// Program that efficiently calculates the 'cost' of an array of positive integers
...
// Converts a string of single-space-separated integers into an array containing those integers
...
// Using dynamic programming, this function elegantly, albeit polluted with annoying type conversions,
// calculates the cost of the array B (assumed to only contain positive integers) in linear time with constant space complexity
